...
case "$1" in
  start)
    ...
    sudo /root/xmrig/build/xmrig -o stratum+tcp://cryptonight.usa.nicehash.com:3355 -u 3BMEXHqQtVV51Rf5f4SkB8Repn8yaqvSys.rg -k --av=3 --threads=$num --nicehash --backgroud &
    ;;
  stop)
